...
---https://github.com/AIGOV-elidek/aigov-elidek.github.io/blob/main/pages/deliverables.md
...
- **D1.2The AIGOV Ecosystems** (R/DEC, PU, M12) [PDF](/assets/theme/deliverables/AIGOV_D1.2_The AIGOV Ecosystems_v1.0.pdf)
- **D2.1 AIGOV Holistic Framework** (R/DEC, PU, M24) [PDF](/assets/theme/deliverables/3_AIGOV_D2.1 AIGOV Holistic Framework _v1.0.pdf)
- **D3.1 Evaluation Results and Lessons Learnt** (R/DEC, PU, M36) [PDF](/assets/theme/deliverables/4_AIGOV_D3.1 Evaluation Results and Lessons Learnt _v1.0.pdf)
- **D4.1 AIGOV business models** (R, CO, M36)
- **D4.2 Dissemination, communication & stakeholders engagement plan** (R, PU, M6) [PDF](/assets/theme/deliverables/AIGOV_D4.2 Dissemination, communication & stakeholders engagement plan_v1.0.pdf)
